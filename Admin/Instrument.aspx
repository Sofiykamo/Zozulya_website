<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Instrument.aspx.cs" Inherits="Shop.Admin.Instrument" %>
        ...
        function ImagePreview(input) { 
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    $('#<%=imgInstrument.ClientID%>').prop('src', e.target.result)
                        .width(200)
                        .height(200);
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            <h4 class="sub-title">Musical Instrument</h4>
                                            <div>
                                                <div class="form-group">
                                                    <label>Instrument Name</label>
                                                    <div>
                                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control"
                                                            placeholder="Enter Instrument name"></asp:TextBox>
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control"
                                                            placeholder="Enter Instrument description" TextMode="MultiLine"></asp:TextBox>
                                                  ...
                                                  <div class="form-group">
                                                    <label> Musical Instrument Price ($)</label>
                                                    <div>
                                                        <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control"
                                                            placeholder="Enter Instrument Price"></asp:TextBox>
                                                  ...
                                                  <div class="form-group">
                                                    <label> Musical Instrument Quantity</label>
                                                    <div>
                                                        <asp:TextBox ID="txtQuantity" runat="server" CssClass="form-control"
                                                            placeholder="Enter Instrument Quantity"></asp:TextBox>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:FileUpload ID="fuInstrumentImage" runat="server" CssClass="form-control"
                                                ...
                                                <div>
                                                    <asp:Image ID="imgInstrument" runat="server" CssClass="img-thumbnail" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs" >
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <asp:Repeater ID="rInstrument" runat="server" OnItemCommand="rInstrument_ItemCommand" 
                                                        OnItemDataBound="rInstrument_ItemDataBound">
                                                        <HeaderTemplate>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                                        CssClass="badge bg-danger" CommandArgument='<%# Eval("InstrumentId") %>'
                                                                        OnClientClick="return confirm('Do you want to delete this musical instrument?');"
